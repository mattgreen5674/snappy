...
use App\Clients\Countries as SportsMonkCountryListApiClient;
use Exception;
...
class SportsMonkCountryListTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_returns_data_and_meta_when_api_response_is_successful(): void
    {
        ...
        $client = new SportsMonkCountryListApiClient;
        $result = $client->list();
    ...
    public function it_throws_exception_when_api_call_fails(): void
    {
        ...
        $this->expectExceptionMessage('Sports Monk API getting countries list failed');
    ...
    public function it_calls_build_query_parameters_with_correct_values(): void
    {
        Config::set('sportsmonk.api.base_url', 'https://sports_monk_test_api_url/api');
        Config::set('sportsmonk.api.key', 'sp0rt5MoNKT3stApiKEy');
        $url = 'https://sports_monk_test_api_url/api/core/countries?api_token=sp0rt5MoNKT3stApiKEy&idAfter=2345&per_page=2';
